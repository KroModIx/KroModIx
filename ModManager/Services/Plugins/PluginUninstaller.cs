...
public sealed class PluginUninstaller
{
    ...
    /// <param name="deleteData">Persistente Config löschen (<c>~/.config/ModManager/plugin-data/&lt;id&gt;/</c>).</param>
    /// <param name="deleteCache">Cache löschen (<c>~/.cache/ModManager/plugin-cache/&lt;id&gt;/</c>).</param>
